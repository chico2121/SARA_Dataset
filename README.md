...
Synthetic dataset used for model training in the IEEE Access paper ["A Body Part Embedding Model With Datasets for Measuring Human Motion Similarity in 2D"](https://ieeexplore.ieee.org/document/9366759)
